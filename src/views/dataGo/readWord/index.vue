<!--
 * @Author: bekon
 * @Date: 2025-02-18 17:10:43
 * @LastEditors: bekon
 * @LastEditTime: 2025-03-25 14:07:07
 * @FilePath: /report-background-system/src/views/dataGo/readWord/index.vue
 * @Description: 
 * 
-->
<template>
  <page-header-wrapper>
    <!-- <div class="page-content" ref="pageContent">
      <iframe ref="myIframe" :src="url" :width="width" :height="height" frameborder="0"></iframe>
    </div> -->
    <div class="tools">
      <div class="tools__container">
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/merge_pdf" title="合并PDF">
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/split_pdf" title="拆分 PDF">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <g fill="rgb(93.333333%,42.352941%,30.196078%)" fill-rule="evenodd">
                  <path
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/compress_pdf" title="压缩PDF">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
            ...
            <h3>压缩PDF</h3>
            <div class="tools__item__content">
              <p>减小PDF文件的尺寸，但同时保持最佳质量。优化您的PDF文件。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/pdf_to_word" title="PDF 转换至 Word">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/pdf_to_powerpoint" title="PDF 转换至 PowerPoint">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/pdf_to_excel" title="PDF 转换至 Excel">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
                  d="M32.324 15.656h-9.55c-2.477 0-3.375.258-4.28.742a5.06 5.06 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.55H5.18c-1.8 0-2.453-.187-3.113-.54a3.69 3.69 0 0 1-1.527-1.527C.188 29.598 0 28.945 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54a3.69 3.69 0 0 1 1.527 1.527c.352.66.54 1.313.54 3.113zm0 0"
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/word_to_pdf" title="Word转换至PDF文件">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
            ...
            <h3>Word转换至PDF文件</h3>
            <div class="tools__item__content">
              <p>将你的DOC或DOCX文件转换为PDF，以方便查看。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/powerpoint_to_pdf" title="PowerPoint 转换至 PDF">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
            ...
            <h3>PowerPoint 转换至 PDF</h3>
            <div class="tools__item__content">
              <p>将PPT转换为PDF文件，与原来的PPT或PPTX文件完全一样，并保持最佳质量。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/excel_to_pdf" title="Excel 转换至 PDF">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
                  d="M17.676 34.344h9.55c2.477 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.098-2.102c.484-.902.742-1.8.742-4.277v-9.547H44.82c1.8 0 2.453.188 3.113.54s1.176.87 1.527 1.527.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.527-.54-1.312-.54-3.113zm0 0"
            ...
            <h3>Excel 转换至 PDF</h3>
            <div class="tools__item__content">
              <p>把EXCEL表格转换为PDF文件，以方便查看。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <div class="badge badge--new">全新功能！</div>
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/edit-pdf" title="编辑PDF文件">
            <div class="tools__item__icon">
              <svg
            ...
            <h3>编辑PDF文件</h3>
            <div class="tools__item__content">
              <p>给PDF文件添加文本、图片、形状或手写的注释。编辑已添加内容的大小、字体和颜色。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/pdf_to_jpg" title="PDF转JPG">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
                  d="M32.324 15.656h-9.55c-2.477 0-3.375.258-4.28.742a5.06 5.06 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.55H5.18c-1.8 0-2.453-.187-3.113-.54a3.69 3.69 0 0 1-1.527-1.527C.188 29.598 0 28.945 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54a3.69 3.69 0 0 1 1.527 1.527c.352.66.54 1.313.54 3.113zm0 0"
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/jpg_to_pdf" title="JPG转PDF">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
                  d="M17.676 34.344h9.55c2.477 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.098-2.102c.484-.902.742-1.8.742-4.277v-9.547H44.82c1.8 0 2.453.188 3.113.54s1.176.87 1.527 1.527.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.527-.54-1.312-.54-3.113zm0 0"
            ...
            <h3>JPG转PDF</h3>
            <div class="tools__item__content">
              <p>将您的图片转换为PDF文件，还可以调整方向和边距。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/sign-pdf" title="PDF 签名">
            <div class="tools__item__icon">
            ...
            <h3>PDF 签名</h3>
            <div class="tools__item__content">
              <p>自己签名，或者请求他人进行电子签名。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/pdf_add_watermark" title="水印">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50">
                <path
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/rotate_pdf" title="旋转PDF">
            <div class="tools__item__icon">
            ...
            <h3>旋转PDF</h3>
            <div class="tools__item__content">
              <p>随意旋转您的PDF文件。一次旋转多个PDF文件！</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/html-to-pdf" title="HTML 转换至PDF">
            <div class="tools__item__icon">
            ...
            <h3>HTML 转换至PDF</h3>
            <div class="tools__item__content">
              <p>将 HTML 中的网页转换为 PDF。复制并粘贴所需页面的 URL地址， 然后一键将其转换为 PDF。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/unlock_pdf" title="PDF 解锁">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 100 100" fill-rule="evenodd">
                <path
                  d="M16.024 0h67.95c5.572 0 7.593.58 9.63 1.67s3.636 2.688 4.725 4.725 1.67 4.058 1.67 9.63v67.95c0 5.572-.58 7.593-1.67 9.63s-2.688 3.636-4.725 4.725-4.058 1.67-9.63 1.67h-67.95c-5.572 0-7.593-.58-9.63-1.67S2.76 95.642 1.67 93.605 0 89.548 0 83.976v-67.95c0-5.572.58-7.593 1.67-9.63S4.358 2.76 6.395 1.67 10.452 0 16.024 0z"
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/protect-pdf" title=" PDF加密">
            <div class="tools__item__icon">
        ...
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/organize-pdf" title="排列PDF文件">
            <div class="tools__item__icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                />
                <g fill="#fff">
                  <mask><use xlink:href="#A" /></mask>
                  <use fill-rule="nonzero" xlink:href="#A" />
                  <mask><use xlink:href="#B" /></mask>
            ...
            <h3>排列PDF文件</h3>
            <div class="tools__item__content">
              <p>根据自己的意愿对PDF文件中的页面进行排序。你可以随时在你的文件中删除或添加PDF页面。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/convert-pdf-to-pdfa" title="PDF转换至PDF/A">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 100 100" fill-rule="evenodd">
                <path
            ...
            <div class="tools__item__content">
              <p>
                将你的PDF转换为PDF/A。PDF/A是用于长期存档的ISO标准化PDF版本。将来访问这个PDF文件时，它还是原有的格式。
              </p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/repair-pdf" title="修复 PDF">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50" fill-rule="evenodd">
                <path
            ...
            <h3>修复 PDF</h3>
            <div class="tools__item__content">
              <p>修复已损坏的PDF文件，并恢复其中的数据。利用我们的修复工具来修复PDF文件。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/add_pdf_page_number" title="添加页码">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50" fill-rule="evenodd">
                <path
                  d="M31.523 28h14.953c1.223 0 1.668.13 2.117.367.44.234.805.598 1.04 1.04.242.45.367.895.367 2.117v14.953c0 1.223-.13 1.668-.367 2.117-.234.44-.598.805-1.04 1.04-.45.242-.895.367-2.117.367H31.523c-1.223 0-1.668-.13-2.117-.367-.44-.234-.805-.598-1.04-1.04-.242-.45-.367-.895-.367-2.117V31.523c0-1.223.13-1.668.367-2.117.234-.44.598-.805 1.04-1.04.45-.242.895-.367 2.117-.367zm0-28h14.953c1.223 0 1.668.13 2.117.367.44.234.805.598 1.04 1.04.242.45.367.895.367 2.117v14.953c0 1.223-.13 1.668-.367 2.117-.234.44-.598.805-1.04 1.04-.45.242-.895.367-2.117.367H31.523c-1.223 0-1.668-.13-2.117-.367-.44-.234-.805-.598-1.04-1.04-.242-.45-.367-.895-.367-2.117V3.523c0-1.223.13-1.668.367-2.117.234-.44.598-.805 1.04-1.04C29.855.125 30.3 0 31.523 0zm-28 28h14.953c1.223 0 1.668.13 2.117.367.44.234.805.598 1.04 1.04.242.45.367.895.367 2.117v14.953c0 1.223-.13 1.668-.367 2.117-.234.44-.598.805-1.04 1.04-.45.242-.895.367-2.117.367H3.523c-1.223 0-1.668-.13-2.117-.367-.44-.234-.805-.598-1.04-1.04C.125 48.145 0 47.7 0 46.477V31.523c0-1.223.13-1.668.367-2.117.234-.44.598-.805 1.04-1.04.45-.242.895-.367 2.117-.367zm0-28h14.953c1.223 0 1.668.13 2.117.367.44.234.805.598 1.04 1.04.242.45.367.895.367 2.117v14.953c0 1.223-.13 1.668-.367 2.117-.234.44-.598.805-1.04 1.04-.45.242-.895.367-2.117.367H3.523c-1.223 0-1.668-.13-2.117-.367-.44-.234-.805-.598-1.04-1.04C.125 20.145 0 19.7 0 18.477V3.523C0 2.3.13 1.852.367 1.406A2.56 2.56 0 0 1 1.406.367C1.855.13 2.3 0 3.523 0zm0 0"
            ...
            <h3>添加页码</h3>
            <div class="tools__item__content">
              <p>轻松将页码插入PDF文件。可选择页码的位置、大小、格式和字体！</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/scan-pdf" title="扫描为PDF">
            <div class="tools__item__icon">
            ...
            <h3>扫描为PDF</h3>
            <div class="tools__item__content">
              <p>使用你的智能手机扫描文件，并立即发送至你的浏览器。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/ocr-pdf" title="OCR PDF">
            <div class="tools__item__icon">
            ...
            <h3>OCR PDF</h3>
            <div class="tools__item__content">
              <p>轻松将扫描PDF文件转换为可搜索內容、可选择內容的文件。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <div class="badge badge--new">全新功能！</div>
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/compare-pdf" title="比较 PDF">
            <div class="tools__item__icon">
            ...
            <h3>比较 PDF</h3>
            <div class="tools__item__content">
              <p>并排显示文件比较，轻松发现不同文件版本之间的更改。</p>
            </div>
          </a>
        </div>
        <div class="tools__item">
          <div class="badge badge--new">全新功能！</div>
          <a target="_blank" href="https://www.ilovepdf.com/zh-cn/redact-pdf" title="PDF 标记密文">
            <div class="tools__item__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="49" viewBox="0 0 50 50" fill="none">
                <path
                  fill="#4A7AAB"
            ...
            <h3>PDF 标记密文</h3>
            <div class="tools__item__content">
              <p>永久删除文件中的可见文本和图形。使用“PDF 标记密文”工具将 PDF 文本和敏感信息涂黑。</p>
            </div>
          </a>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    const page = this.$refs.pageContent
    this.width = page.offsetWidth - 48
    this.height = page.offsetHeight - 48
  },
}
</script>

<style lang="less" scoped>
@import url(./readWord.css);
</style>